 ...
 * 
 */
@WebServiceClient(name = "WSOperaciones", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8080/ServidorMio/WSOperaciones?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/ServidorMio/WSOperaciones?wsdl");
